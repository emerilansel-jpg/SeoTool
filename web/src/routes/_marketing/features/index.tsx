...
const featuresDescription =
  "Explore SeoTool.im's open-source SEO tools for AI-agent workflows, Google Search Console MCP, keyword research, rank tracking, backlinks, site audits, competitor analysis, and AI visibility.";
        ...
        <section>
          <div className="border-b border-[var(--color-border-subtle)] pb-4">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]">
              ...
              backlinks, and first-party Search Console data through SeoTool.im.
            </p>
          </div>
