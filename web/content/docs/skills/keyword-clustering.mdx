...
Set up [SeoTool.im MCP](/docs/mcp) so your agent can read saved keywords, inspect SERPs, and use SeoTool.im project context while clustering.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Clustering skill](https://github.com/emerilansel-jpg/SeoTool/tree/main/.agents/skills/keyword-clustering)
