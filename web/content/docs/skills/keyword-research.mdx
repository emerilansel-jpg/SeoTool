...
- Ask before saving keywords back to SeoTool.im.
...
- Confirm before saving selected keywords to SeoTool.im.

## Use it with SeoTool.im MCP

Set up [SeoTool.im MCP](/docs/mcp) so your agent can research live keyword metrics, inspect Google SERPs, check saved keywords, and save selected terms with your approval.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Research skill](https://github.com/emerilansel-jpg/SeoTool/tree/main/.agents/skills/keyword-research)
