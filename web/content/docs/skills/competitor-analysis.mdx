...
Set up [SeoTool.im MCP](/docs/mcp) so your agent can inspect domain overview data, ranking keywords, SERPs, and backlink context.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Competitor Analysis skill](https://github.com/emerilansel-jpg/SeoTool/tree/main/.agents/skills/competitor-analysis)
