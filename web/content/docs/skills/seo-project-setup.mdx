...
- Recommend the next SeoTool.im Agent Skill to run.
...
Set up [SeoTool.im MCP](/docs/mcp) so your agent can confirm the right SeoTool.im project and use live SEO data in later workflows.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Project Setup skill](https://github.com/emerilansel-jpg/SeoTool/tree/main/.agents/skills/seo-project-setup)
