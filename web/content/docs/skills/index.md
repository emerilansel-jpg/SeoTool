...
SeoTool.im Agent Skills let you hand repeatable SEO workflows to your AI agent.
...
You stay in charge of strategy. Your agent uses SeoTool.im data and the skill instructions to return a recommendation, plan, or shortlist.

## Set up SeoTool.im Agent Skills

1. [Set up SeoTool.im MCP](/docs/mcp).
2. [Set up SeoTool.im Agent Skills](/docs/skills/setup).

MCP connects your agent to SeoTool.im data. Skills tell your agent which SEO workflow to run.
...
SeoTool.im uses the same `SKILL.md` pattern supported by modern AI agents. To learn how skills work in your agent, read:
