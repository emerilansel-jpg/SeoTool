...
import { L as Link } from "./router-nYHkPPcI.js";
const navLinks = [
        ...
        "nav",
        {
          ...
          children: [
            navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                to: link.to,
                className: `shrink-0 transition-colors hover:text-[var(--color-brand)] ${link.label === "Features" || link.label === "Pricing" ? "hidden sm:inline" : ""}`,
