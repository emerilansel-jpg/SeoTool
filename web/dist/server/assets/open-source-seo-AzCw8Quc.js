...
import { ab as frontmatter, D as DocsBody, ac as MDXContent, d as defaultMdxComponents } from "./router-DyJXM2Bq.js";
...
function OpenSourceSeoPage() {
  return /* @__PURE__ */ jsxs("article", { className: "mx-auto max-w-4xl text-neutral-900", children: [
    /* @__PURE__ */ jsxs("header", { className: "mb-10 border-b border-[var(--color-border-subtle)] pb-8", children: [
      /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-[var(--color-brand-accent)]", children: "Open Source SEO" }),
...
function OpenSourceSeoCta() {
  return /* @__PURE__ */ jsxs("section", { className: "mt-14 rounded-xl border border-[var(--color-border-subtle)] bg-white p-6", children: [
    /* @__PURE__ */ jsx("p", { className: "text-xl font-semibold tracking-tight text-neutral-950", children: "Try SeoTool.im, or follow along on GitHub" }),
    /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]", children: "Try the hosted app if you want to get started right away. Or, check it out on GitHub. Make sure to give it a star!" }),
