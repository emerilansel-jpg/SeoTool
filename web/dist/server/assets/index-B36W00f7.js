...
function KeywordResearchLibraryPage() {
  return /* @__PURE__ */ jsxs("article", { className: "mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxs("header", { className: "max-w-3xl", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "mt-3 text-4xl font-semibold leading-tight tracking-tight text-neutral-950 md:text-6xl", children: "The Keyword Research Strategy Library" }),
      /* @__PURE__ */ jsx("p", { className: "mt-5 text-lg leading-8 text-[var(--color-brand-muted)]", children: "Eight practitioner plays that treat keyword research as demand discovery, sourced from real interviews with working SEOs, executable inside SeoTool.im." })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: "mt-12", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "How to do keyword research: demand discovery, not a volume spreadsheet" }),
      /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]", children: "Most guides teach you to export a volume report and sort descending. These plays start earlier, where demand originates: customer language, question mining, your own Search Console. They end with pages mapped to intent, not keywords stuffed into paragraphs. Each play is a full walkthrough with the copy-paste MCP prompt that runs it." }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "mt-12 rounded-xl border border-[var(--color-border-subtle)] bg-white p-6 md:p-8", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "What Google Keyword Planner hides (and what to use instead)" }),
      /* @__PURE__ */ jsx("p", { className: "mt-3 max-w-3xl text-sm leading-6 text-neutral-700", children: "Keyword Planner is an ads tool wearing an SEO costume: it buckets close variants into one number, rounds volumes into bands, and hides everything with no ad demand. That's fine for bidding. It's blinding for content strategy." }),
      /* @__PURE__ */ jsxs("p", { className: "mt-3 max-w-3xl text-sm leading-6 text-neutral-700", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "mt-12", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "Free keyword research tools for every play" }),
      /* @__PURE__ */ jsxs("p", { className: "mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]", children: [
        ...
        " ",
        /* @__PURE__ */ jsx("a", { href: "/features/keyword-research", className: "font-medium text-neutral-950 underline decoration-[var(--color-brand-accent)] underline-offset-4", children: "SeoTool.im's keyword research" }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "mt-12", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "Keyword research FAQ" }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "mt-12 flex flex-col items-start justify-between gap-4 rounded-xl border border-[var(--color-border-subtle)] bg-white p-6 sm:flex-row sm:items-center md:p-8", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "The Keyword Research Playbook" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-xl text-sm leading-6 text-[var(--color-brand-muted)]", children: "The plays as a working PDF: checklists, the MCP prompts, and the keyword-map template. Ungated." })
      ] }),
      /* @__PURE__ */ jsxs("a", { href: "/library/keyword-research/keyword-research-playbook.pdf", className: "inline-flex h-11 shrink-0 items-center justify-center rounded-lg bg-neutral-950 px-5 text-sm font-medium text-white transition-colors hover:bg-neutral-800", children: [
