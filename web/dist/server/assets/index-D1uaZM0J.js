...
let structuredData = {
  "contents": [{
    ...
    "heading": "dataforseo-api-key-setup",
    "content": "New DataForSEO accounts include $1 of free credit to test with, and the minimum top-up is $50. See pricing for cost estimates. When self-hosting, you pay DataForSEO directly for API calls without any platform credit deductions."
  }, {
    ...
    "heading": "ai-features-jet",
    "content": "AI features like Jet, the in-app SEO agent, are optional. Set the OPENROUTER_API_KEY environment variable to enable them. Create a key at openrouter.ai/settings/keys."
  }],
  "headings": [{
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.p, {
      ...
      children: ["New DataForSEO accounts include $1 of free credit to test with, and the minimum top-up is $50. See ", jsxRuntimeExports.jsx(_components.a, {
        href: "/pricing",
        children: "pricing"
      }), " for cost estimates. When self-hosting, you pay DataForSEO directly for API calls without any platform credit deductions."]
    }), "\n", jsxRuntimeExports.jsx(_components.h2, {
      id: "optional-features",
      children: "Optional features"
      ...
      children: ["AI features like Jet, the in-app SEO agent, are optional. Set the ", jsxRuntimeExports.jsx(_components.code, {
