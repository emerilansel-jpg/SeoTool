...
import { af as frontmatter, D as DocsBody, ag as MDXContent, d as defaultMdxComponents, ah as SITE_URL, ai as toCanonicalUrl, aj as PATH } from "./router-CSD96jeV.js";
...
function GoogleSearchConsoleMcpPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "mx-auto max-w-4xl text-neutral-900", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mb-10 border-b border-[var(--color-border-subtle)] pb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-[var(--color-brand-accent)]", children: "Search Console MCP" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 text-4xl font-semibold leading-tight tracking-tight text-neutral-950 md:text-6xl", children: frontmatter.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex flex-col gap-3 sm:flex-row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://seotool.im/sign-up", className: "inline-flex h-10 items-center justify-center rounded-lg bg-neutral-950 px-5 text-sm font-medium text-white transition-colors hover:bg-neutral-800", children: [
        "Get started",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2", "aria-hidden": "true", children: "→" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-xs text-neutral-500", children: "$10/month, 30-day money-back guarantee. Search Console tools never use credits." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DocsBody, { className: "min-w-0 text-neutral-800 [&_a]:!text-neutral-950 [&_h2]:!text-neutral-950 [&_h2_a]:!no-underline [&_h3]:!text-neutral-950 [&_h3_a]:!no-underline [&_h4]:!text-neutral-950 [&_h4_a]:!no-underline [&_h5_a]:!no-underline [&_h6_a]:!no-underline [&_li]:!text-neutral-700 [&_li_a]:font-medium [&_li_a]:underline [&_li_a]:decoration-[var(--color-brand-accent)] [&_li_a]:underline-offset-4 [&_li_a:hover]:!text-neutral-700 [&_p]:!text-neutral-700 [&_p_a]:font-medium [&_p_a]:underline [&_p_a]:decoration-[var(--color-brand-accent)] [&_p_a]:underline-offset-4 [&_p_a:hover]:!text-neutral-700 [&_strong]:!text-neutral-950", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MDXContent, { components: {
...
function GoogleSearchConsoleMcpCta() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-14 rounded-xl border border-[var(--color-border-subtle)] bg-white p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-semibold tracking-tight text-neutral-950", children: "Point your AI at your real search data" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]", children: "No Google Cloud project. Zero credits to read your own data. Works with Claude, Codex, OpenClaw, OpenCode, and Gemini." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex flex-col gap-3 sm:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://seotool.im/sign-up", className: "inline-flex h-10 items-center justify-center rounded-lg bg-neutral-950 px-4 text-sm font-medium text-white transition-colors hover:bg-neutral-800", children: [
        "Get started",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2", "aria-hidden": "true", children: "→" })
      ] }),
