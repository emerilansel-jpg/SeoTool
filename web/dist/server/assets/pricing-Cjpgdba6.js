import { r as reactExports, U as jsxRuntimeExports } from "./worker-entry-BkbuqH8c.js";
...
function Pricing() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "mx-auto max-w-5xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { role: "group", "aria-label": "Billing period", className: "inline-flex rounded-full border border-[var(--color-border-subtle)] bg-[var(--color-surface-raised)] p-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", "aria-pressed": !annual, onClick: () => setAnnual(false), className: `rounded-full px-5 py-2 text-sm font-medium transition-colors ${annual ? "text-[var(--color-brand-muted)] hover:text-[var(--color-brand)]" : "bg-[var(--color-cta)] text-white"}`, children: "Monthly" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", "aria-pressed": annual, onClick: () => setAnnual(true), className: `rounded-full px-5 py-2 text-sm font-medium transition-colors ${annual ? "bg-[var(--color-cta)] text-white" : "text-[var(--color-brand-muted)] hover:text-[var(--color-brand)]"}`, children: [
        "Annual",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `ml-2 rounded-full px-2 py-0.5 text-xs font-semibold ${annual ? "bg-white/20 text-white" : "bg-[var(--color-brand-accent)]/15 text-[var(--color-brand-accent)]"}`, children: "−20%" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: PLANS.map((plan) => {
      const monthlyPrice = annual ? Math.round(plan.price * ANNUAL_DISCOUNT) : plan.price;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative flex flex-col rounded-xl border p-6 ${plan.highlight ? "border-[var(--color-brand-accent)] bg-[var(--color-surface-raised)] shadow-sm ring-1 ring-[var(--color-brand-accent)]/30" : "border-[var(--color-border-subtle)] bg-[var(--color-surface-raised)]"}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-[var(--color-brand-muted)]", children: plan.price === 0 ? "Free forever" : annual ? `Billed annually (${usd(monthlyPrice * 12)}/yr)` : "Billed monthly" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-14", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "mt-5 divide-y divide-[var(--color-border-subtle)]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 first:pt-0 last:pb-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "mt-1.5 text-sm leading-6 text-[var(--color-brand-muted)]", children: "Yes. Changes take effect immediately and your usage quotas reset to match the new plan. Billing is handled through PayPal Subscriptions." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4 first:pt-0 last:pb-0", children: [
