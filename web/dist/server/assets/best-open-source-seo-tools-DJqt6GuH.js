...
function _createMdxContent(props) {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(_components.p, {
      ...
      children: ["Note: SeoTool.im publishes this guide, and SeoTool.im is one of the tools listed, as the project has 2,000+ stars on GitHub. We have tried to make this useful even if you never touch it. We love open source and think it's the future of SEO tools: ", jsxRuntimeExports.jsx(_components.a, {
        href: "/open-source-seo",
      ...
      children: ["SeoTool.im is an open source alternative to Semrush and Ahrefs, built to be the only SEO tool that companies or small agencies need. It covers keyword research, rank tracking, backlinks, site audits, AI brand visibility, and an AI search prompt explorer. See them all on the ", jsxRuntimeExports.jsx(_components.a, {
        href: "/features",
        children: "features page"
      }), "."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["It relies on ", jsxRuntimeExports.jsx(_components.a, {
        href: "https://dataforseo.com",
        children: "DataForSEO"
      }), ", a paid service, which is the gold standard for SEO data with pay-as-you-go pricing. Many features cost money to run, but far less than a legacy SaaS seat, and the ", jsxRuntimeExports.jsx(_components.a, {
        href: "/pricing",
        children: "costs are documented"
      }), "."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["SeoTool.im also has an ", jsxRuntimeExports.jsx(_components.a, {
        href: "/docs/mcp",
        children: "MCP server"
      }), " and AI skills, so you can use Claude Code, Codex, or OpenClaw to handle tedious SEO work like a first pass of keyword research, then dig into the results in the SeoTool.im UI. That is different from pointing an agent at DataForSEO's MCP directly. You can save data to your SeoTool.im account through the MCP, like tags for clustering keywords, and you can ask the agent for a link to view its research in SeoTool.im instead of trusting whatever it reports back."]
    }), "\n", jsxRuntimeExports.jsx(_components.h2, {
      ...
      children: ["One warning on Keyword Research. It relies on the ", jsxRuntimeExports.jsx(_components.a, {
        href: "https://docs.serpbear.com/miscellaneous/integrate-google-ads",
      ...
      children: ["The difference is how you run them. SEONaut is a self-hosted web app (Docker), with a hosted version and the full feature list at ", jsxRuntimeExports.jsx(_components.a, {
        href: "https://seonaut.org/features/",
      ...
      children: ["If you want one open source tool that covers most of SEO, start with SeoTool.im. Self-host it with Docker or Cloudflare Workers, or use the hosted version at ", jsxRuntimeExports.jsx(_components.a, {
        href: "https://seotool.im",
        children: "seotool.im"
      }), " if you would rather not run it yourself."]
    }), "\n", jsxRuntimeExports.jsxs(_components.p, {
      children: ["We will keep this guide current. If there is an open source SEO project you love that we did not cover, email us at ", jsxRuntimeExports.jsx(_components.a, {
        href: "mailto:support@seotool.im",
