...
import { L as Link, l as featureGroups } from "./router-CSD96jeV.js";
...
function SiteFooter({ className }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "inline-block hover:opacity-80 transition-opacity", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid grid-cols-2 gap-8 md:grid-cols-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-[var(--color-brand)]", children: "Free tools" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex flex-col gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/free-tools", children: "All free tools" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/free-tools/ai-visibility-checker", children: "AI Visibility Checker" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/library/ai-search-geo", children: "AI Search Library" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
