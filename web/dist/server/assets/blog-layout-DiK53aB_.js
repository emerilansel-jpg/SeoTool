...
function BlogLayout({ children }) {
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-[var(--color-surface)] text-neutral-950", children: [
    /* @__PURE__ */ jsx("header", { className: "border-b border-[var(--color-border-subtle)] bg-[var(--color-surface)]", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-4 px-5 sm:px-6", children: [
      /* @__PURE__ */ jsx(
        Link,
        {
          to: "/",
