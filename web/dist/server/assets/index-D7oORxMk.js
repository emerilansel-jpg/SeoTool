...
function AiSearchGeoLibraryPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "mx-auto max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "max-w-3xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 text-4xl font-semibold leading-tight tracking-tight text-neutral-950 md:text-6xl", children: "The AI Search Optimization Library" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-lg leading-8 text-[var(--color-brand-muted)]", children: "Plays for the newest front page of search: the answer AI assistants give when buyers ask who to choose. Built from live AI citation data, executable with free tools." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "GEO plays: get cited, then get chosen" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]", children: "Every play ends in something measurable: a mention count, a cited page, a share-of-voice number. No recycled speculation about training AI to love your brand, just the mechanics of how answers get assembled and who ends up in them." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-12 rounded-xl border border-[var(--color-border-subtle)] bg-white p-6 md:p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "Why AI search is a different discipline" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-3xl text-sm leading-6 text-neutral-700", children: "A Google result page shows ten links and lets the buyer choose. An AI answer names a shortlist, sometimes three brands, sometimes one, and explains why. There is no position five to rank for. Your brand is in the answer or it is invisible at the exact moment of shortlisting." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-3xl text-sm leading-6 text-neutral-700", children: "The levers differ too. Assistants assemble answers from pages that state conclusions plainly, from third-party sources buyers already trust (roundups, comparisons, communities), and from fresh material their retrieval step can find. Classic ranking signals still open the door, but the citation decision happens on the page itself: does this page answer the question in a form a model can quote?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-3xl text-sm leading-6 text-neutral-700", children: "That is good news for smaller teams. You cannot out-spend a DR-90 publisher on links, but you can out-answer them on the questions your buyers actually ask, and that is what AI citations reward." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "Tools for every play" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 max-w-2xl text-sm leading-6 text-[var(--color-brand-muted)]", children: [
        "Start with the",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/free-tools/ai-visibility-checker", className: "font-medium text-neutral-950 underline decoration-[var(--color-brand-accent)] underline-offset-4", children: "free AI visibility checker" }),
        " ",
        "to see your baseline. Then track ChatGPT and AI Overviews mentions, competitor share of voice, and every cited page inside",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/features/ai-brand-visibility", className: "font-medium text-neutral-950 underline decoration-[var(--color-brand-accent)] underline-offset-4", children: "SeoTool.im's AI brand visibility" }),
        " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "AI search optimization FAQ" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-12 flex flex-col items-start justify-between gap-4 rounded-xl border border-[var(--color-border-subtle)] bg-white p-6 sm:flex-row sm:items-center md:p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold tracking-tight text-neutral-950", children: "Find out where you stand" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-xl text-sm leading-6 text-[var(--color-brand-muted)]", children: "Run the free check, then track every mention, competitor, and cited page over time. Takes about ten seconds." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/free-tools/ai-visibility-checker", className: "inline-flex h-11 shrink-0 items-center justify-center rounded-lg bg-neutral-950 px-5 text-sm font-medium text-white transition-colors hover:bg-neutral-800", children: [
