...
function _createMdxContent(props) {
  ...
  return jsxs(Fragment, {
    children: [jsx(_components.p, {
      ...
      children: ["First, ", jsx(_components.a, {
        href: "/docs/mcp",
        children: "set up SeoTool.im MCP"
      }), ". MCP gives your agent access to SeoTool.im data."]
    }), "\n", jsxs(_components.p, {
      children: ["Then add the SeoTool.im ", jsx(_components.code, {
        children: "SKILL.md"
      ...
      children: ["Each skill page also links to its source ", jsx(_components.code, {
        children: "SKILL.md"
      }), "."]
    }), "\n", jsx(_components.h2, {
      id: "run-a-skill",
      ...
      children: ["Start with ", jsx(_components.a, {
        href: "/docs/skills/seo-project-setup",
        children: "SEO Project Setup"
      }), " if this is a new SEO project, or ", jsx(_components.a, {
        href: "/docs/skills/seo-coach",
        children: "SEO Coach"
