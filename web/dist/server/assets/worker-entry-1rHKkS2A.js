...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-8FmYmC_H.js");
...
async function loadEntries() {
  const routerEntry = await import("./router-DBIHXVvV.js").then((n2) => n2.aX);
  return {
