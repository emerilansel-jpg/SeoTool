...
description: Write and review content for the SeoTool.im website (web/) — blog posts, guides, feature pages, FAQs. Distills the philosophy for on-brand, useful, accurate content. Use whenever adding or editing user-facing prose in web/content or web/src.
metadata:
  internal: true
---

# SeoTool.im Web Content
...
- If a reader trusted every claim and screenshot, then opened SeoTool.im right now, where would reality not match?
