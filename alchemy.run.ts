...
const dataEnv = {
  ...
  PAYPAL_CLIENT_ID: optionalSecret("PAYPAL_CLIENT_ID"),
  PAYPAL_CLIENT_SECRET: optionalSecret("PAYPAL_CLIENT_SECRET"),
  PAYPAL_MODE: optionalVar("PAYPAL_MODE"),
  PAYPAL_WEBHOOK_ID: optionalSecret("PAYPAL_WEBHOOK_ID"),
