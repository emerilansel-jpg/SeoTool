...
# SeoTool.im Keyword Research

## Goal

Turn seed topics into a prioritized keyword opportunity set using SeoTool.im MCP data. The output should help the user decide what to target, what to save, and what to research next.
...
- Do not invent metrics. If SeoTool.im does not return a value, write `unknown`.
