...
INSERT INTO cms_posts (id, slug, title, description, content_md, status, published_at, author_user_id, created_at, updated_at) VALUES ($md$seed-post-best-open-source-seo-tools$md$, $md$best-open-source-seo-tools$md$, $md$The Best Open Source SEO Tools in 2026$md$, $md$Open source SEO tools in 2026: SeoTool.im, SerpBear, SEONaut, LibreCrawl, and SEOMachine — what each one does, what it costs to run, and how to self-host.$md$, $md$There are a lot of open source SEO projects on GitHub, but only a handful are mature enough to rely on. This guide covers those, plus a few honorable mentions worth watching or testing.
...
We will keep this guide current. If there is an open source SEO project you love that we did not cover, email us at support@seotool.im and we will test it and consider adding it.$md$, 'published', $md$2026-06-05T00:00:00.000Z$md$, NULL, $md$2026-09-16T15:51:46.270Z$md$, $md$2026-09-16T15:51:46.270Z$md$) ON CONFLICT (slug) DO NOTHING;--> statement-breakpoint
INSERT INTO cms_posts (id, slug, title, description, content_md, status, published_at, author_user_id, created_at, updated_at) VALUES ($md$seed-post-dark-queries$md$, $md$dark-queries$md$, $md$The Dark Query Problem: Why Search Console Hides Most of Your Searches$md$, $md$Google shows you the clicks but hides the questions behind them. Here''s how to triangulate the searches you can''t see using data you already have.$md$, $md$Open any page report in Google Search Console. It will tell you, confidently, that this page earned 100 clicks last month. Scroll to the query table underneath, and Google will name maybe seven to fourteen of the searches that drove them. The other 86 clicks came from searches Google won''t show you, anonymized away under privacy thresholds.
...
If you want to explore this yourself, [SeoTool.im](https://seotool.im/) is an affordable, open-source SEO tool that connects Search Console, ranking, and MCP data in one place, so you can start closing the dark-query gap today.$md$, 'published', $md$2026-07-20T00:00:00.000Z$md$, NULL, $md$2026-09-16T15:51:46.270Z$md$, $md$2026-09-16T15:51:46.270Z$md$) ON CONFLICT (slug) DO NOTHING;--> statement-breakpoint
INSERT INTO cms_posts (id, slug, title, description, content_md, status, published_at, author_user_id, created_at, updated_at) VALUES ($md$seed-post-seo-for-startups$md$, $md$seo-for-startups$md$, $md$SEO for Startups: A Founder’s Handbook$md$, $md$A founder-focused handbook to SEO for startups: how to use search for market research, early rankings, and smarter growth without wasting time.$md$, $md$If you''ve started a company, you''ve probably considered investing some time into SEO for your startup, or search engine optimization. In this guide, I''ll try to give you an overview of how you should be thinking about SEO as someone building something new.
...
If you want to explore this data yourself, [SeoTool.im](https://seotool.im/) is an affordable SEO tool built by a founder for founders, without the usual bloat of tools made for SEO power users.$md$, 'published', $md$2026-04-22T00:00:00.000Z$md$, NULL, $md$2026-09-16T15:51:46.270Z$md$, $md$2026-09-16T15:51:46.270Z$md$) ON CONFLICT (slug) DO NOTHING;--> statement-breakpoint
INSERT INTO cms_pages (id, slug, title, content_md, status, updated_by_user_id, created_at, updated_at) VALUES ($md$seed-page-privacy$md$, $md$privacy$md$, $md$Privacy Policy$md$, $md$_Last updated: September 10, 2026_

## SeoTool.im Privacy Policy

SeoTool.im ("Company", "we", "us", or "our") is committed to maintaining robust privacy protections for its users. Our Privacy Policy is designed to help you understand how we collect, use, and safeguard the information you provide to us and to assist you in making informed decisions when using our Service.
...
If you operate or use a self-hosted deployment of SeoTool.im, the operator of that deployment controls the information processed there. This Privacy Policy applies to information collected by SeoTool.im through the Site and hosted services.
...
The public Site uses privacy-friendly, cookieless analytics. In the hosted version of the Service, we use essential cookies strictly necessary to authenticate users, maintain secure sessions, and protect accounts.
...
The Site and Service are not directed to anyone under the age of 18. The Site does not knowingly collect or solicit information from anyone under the age of 13. If you believe we have inadvertently collected such information, please contact us at support@seotool.im.

## II. How We Use and Share Information

### Personal Information
Except as otherwise stated in this Privacy Policy, we do not sell, trade, rent, or otherwise share your Personal Information with third parties for marketing purposes without your consent. We share Personal Information with service providers performing operations on our behalf (such as payment processors, email delivery providers, and hosting infrastructure). Those vendors use your Personal Information only at our direction and in accordance with our Privacy Policy.

We use Personal Information to create and secure accounts, authenticate users, provide technical support, process billing, send transactional emails (account verification, password reset, security notices), and deliver product updates.

We may share Personal Information if required to do so by applicable law, regulation, legal process, or enforceable governmental request, or to protect the rights, property, or safety of our users or the public.

### Non-Personal Information
We use Non-Personal Information to help us analyze trends, administer the Site, and improve the user experience.

## III. How We Protect Information

We implement security measures designed to protect your information from unauthorized access, including encryption in transit (HTTPS / TLS), encrypted token storage, and secure server software. Your account is protected by your password, and we urge you to keep your password secure and to log out after each session.

## IV. Your Rights Regarding Personal Information

You have the right at any time to opt out of marketing communications by following the unsubscribe link in promotional emails or by contacting support@seotool.im. You may also update your account information or request account deletion from your account settings.

## V. Links to Other Websites

As part of the Service, we may provide links to external websites. We are not responsible for the privacy practices or content employed by external websites. We encourage you to review the privacy policies of third-party sites before providing personal information.

## VI. Changes to Our Privacy Policy

We reserve the right to update this Privacy Policy at any time. We will post changes to this page with an updated revision date. Significant changes will be communicated via email or prominent in-app notification.

## VII. Contact Us

If you have questions regarding this Privacy Policy or our practices, please contact us by email at support@seotool.im.$md$, 'published', NULL, $md$2026-09-16T15:51:46.270Z$md$, $md$2026-09-16T15:51:46.270Z$md$) ON CONFLICT (slug) DO NOTHING;--> statement-breakpoint
INSERT INTO cms_pages (id, slug, title, content_md, status, updated_by_user_id, created_at, updated_at) VALUES ($md$seed-page-terms-and-conditions$md$, $md$terms-and-conditions$md$, $md$Terms and Conditions$md$, $md$**Last revised on: 6/13/2026**
...
9. **30-Day Right to Opt Out.** You have the right to opt out of the provisions of this Arbitration Agreement by sending a timely written notice of your decision to opt out by email to support@seotool.im within 30 days after first becoming subject to this Arbitration Agreement. Your notice must include your name and address and a clear statement that you want to opt out of this Arbitration Agreement. If you opt out of this Arbitration Agreement, all other parts of these Terms will continue to apply to you. Opting out of this Arbitration Agreement has no effect on any other arbitration agreements that you may currently have with us, or may enter into in the future with us.
   ...
   Email: support@seotool.im
   Website: https://seotool.im$md$, 'published', NULL, $md$2026-09-16T15:51:46.270Z$md$, $md$2026-09-16T15:51:46.270Z$md$) ON CONFLICT (slug) DO NOTHING;--> statement-breakpoint
INSERT INTO cms_pages (id, slug, title, content_md, status, updated_by_user_id, created_at, updated_at) VALUES ($md$seed-page-cookie-policy$md$, $md$cookie-policy$md$, $md$Cookie Policy$md$, $md$Last updated: August 12, 2026
...
For questions about this policy, contact us at support@seotool.im.$md$, 'published', NULL, $md$2026-09-16T15:51:46.270Z$md$, $md$2026-09-16T15:51:46.270Z$md$) ON CONFLICT (slug) DO NOTHING;--> statement-breakpoint
INSERT INTO cms_pages (id, slug, title, content_md, status, updated_by_user_id, created_at, updated_at) VALUES ($md$seed-page-refund-policy$md$, $md$refund-policy$md$, $md$Refund Policy$md$, $md$Last updated: August 12, 2026
...
To request a refund, please email us directly at support@seotool.im with your account details.$md$, 'published', NULL, $md$2026-09-16T15:51:46.270Z$md$, $md$2026-09-16T15:51:46.270Z$md$) ON CONFLICT (slug) DO NOTHING;--> statement-breakpoint
INSERT INTO cms_pages (id, slug, title, content_md, status, updated_by_user_id, created_at, updated_at) VALUES ($md$seed-page-dpa$md$, $md$dpa$md$, $md$Data Processing Addendum (DPA)$md$, $md$Last updated: August 12, 2026
...
If you have GDPR compliance needs or require a signed copy of this DPA, please contact us at support@seotool.im.$md$, 'published', NULL, $md$2026-09-16T15:51:46.270Z$md$, $md$2026-09-16T15:51:46.270Z$md$) ON CONFLICT (slug) DO NOTHING;
