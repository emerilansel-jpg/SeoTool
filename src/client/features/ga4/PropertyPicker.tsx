...
/**
 * GA4 property selector for connected Google accounts. Shared by the Insights
 * card and the project settings section. Unlike GSC there's no per-property
 * permission level — the Admin API only returns properties the grant can see, so
 * every option is selectable. `secondaryAction` is optional.
 */
