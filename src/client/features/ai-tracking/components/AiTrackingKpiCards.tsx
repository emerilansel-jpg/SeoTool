...
import type { AiTrackingKpi, AiTrackingPlatform } from "@/types/schemas/ai-tracking";
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="flex flex-col justify-between">
          <div className="mb-2 flex items-center gap-1.5">
            <p className="text-sm font-medium tracking-tight text-base-content/70">AI Models</p>
            <span className="flex items-center gap-1.5 rounded-full bg-warning/15 px-3 py-1 text-[11px] font-semibold text-warning-content">
              ...
              {isAllSelected ? "All Selected" : PLATFORM_LABELS[selectedPlatform] || selectedPlatform}
            </span>
            {!isAllSelected && (
              <button
                type="button"
        ...
        <div className="flex flex-col justify-between border-base-300 lg:border-l lg:pl-6">
          <div className="mb-1 flex items-center justify-between">
            <p className="text-sm font-medium tracking-tight text-base-content/70">Visibility Score</p>
            <span className="text-xs text-base-content/50">brand appearance %</span>
          </div>
          <div className="flex items-center justify-between">
            ...
            <div className="h-8 w-16">
              <svg viewBox="0 0 64 32" className="size-full overflow-visible">
                ...
                <path d="M 0 16 L 16 12 L 32 18 L 48 8 L 64 4 L 64 32 L 0 32 Z" fill="url(#gradient-emerald)" />
                <path d="M 0 16 L 16 12 L 32 18 L 48 8 L 64 4" stroke="#10b981" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between border-base-300 lg:border-l lg:pl-6">
          <div className="mb-1 flex items-center justify-between">
            <p className="text-sm font-medium tracking-tight text-base-content/70">Brand Reputation</p>
            <span className="text-xs text-base-content/50">sentiment health</span>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="text-3xl font-bold tracking-tight text-base-content">
            ...
            <div className="h-8 w-16">
              <svg viewBox="0 0 64 32" className="size-full overflow-visible">
                ...
                <path d="M 0 20 L 16 14 L 32 16 L 48 10 L 64 6 L 64 32 L 0 32 Z" fill="url(#gradient-blue)" />
                <path d="M 0 20 L 16 14 L 32 16 L 48 10 L 64 6" stroke="#3b82f6" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
          </div>
        </div>
