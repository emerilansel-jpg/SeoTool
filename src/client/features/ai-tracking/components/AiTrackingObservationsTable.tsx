    ...
    <div className="flex flex-col gap-4 rounded-xl border border-base-300 bg-base-100 p-6 shadow-sm">
      <div>
        ...
        <p className="text-xs text-base-content/60">
          Live answers generated by AI assistants, detected positions, and citations.
        </p>
      </div>
                ...
                <div className="flex items-center gap-3 shrink-0">
                  {obs.brandMentioned ? (
                    <span className="badge badge-success badge-xs font-semibold">
                      Mentioned {obs.position != null ? `(#${obs.position})` : ""}
                    </span>
                  ) : (
                ...
                <div className="border-t border-base-200 bg-base-100 p-4 space-y-4 text-xs">
                  {obs.evidence && (
                    <div className="rounded-lg bg-base-200/50 p-3">
                      ...
                      <p className="text-base-content/80 italic">&quot;{obs.evidence}&quot;</p>
                      <div className="mt-2 flex items-center gap-2">
                        <span className="badge badge-xs badge-info">{obs.sentiment} sentiment</span>
                        {obs.position != null && (
                          <span className="badge badge-xs badge-primary">Rank position #{obs.position}</span>
                        )}
                      </div>
                    </div>
                  )}
                        ...
                        {obs.citations.map((c) => (
                          ...
                          >
                            <div className="flex items-center gap-1.5 truncate">
                              ...
                              <span className="truncate text-base-content">{c.title || c.domain}</span>
                            </div>
