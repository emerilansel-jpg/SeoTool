...
function firstPrompts(domain: string | null): string[] {
  ...
  return [
    `Review ${site}. Ideas for what keywords we could target? Use SeoTool.im`,
    "Research my competitors top pages and keywords and tell me what's working. Use SeoTool.im",
  ];
}
