...
import { ContentScoresView } from "@/client/features/content-intelligence/ContentScoresView";
import { PageEntitiesView } from "@/client/features/content-intelligence/PageEntitiesView";

type ResultsTab = "issues" | "pages" | "performance" | "content" | "entities";
    ...
    <>
        ...
        <div className="flex items-start gap-3 rounded-lg border border-warning/30 bg-warning/5 px-4 py-3 text-sm">
          ...
          <p>
            ...
            <span className="text-base-content/70">
              ...
              <code className="font-mono">SeoTool.im-Audit</code> user agent in
      ...
      <div className="card bg-base-100 border border-base-300">
        <div className="card-body gap-3">
          ...
          {activeTab === "content" ? (
            <ContentScoresView projectId={projectId} auditId={audit.id} />
          ) : activeTab === "entities" ? (
            <PageEntitiesView projectId={projectId} auditId={audit.id} />
          ) : (
            <>
...
function ResultsHeader({
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
      ...
      {activeTab !== "content" && <ExportDropdown onExport={onExport} />}
    </div>
  );
}
