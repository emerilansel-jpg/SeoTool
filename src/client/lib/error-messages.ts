...
const STANDARD_MESSAGES: Record<ErrorCode, string> = {
  ...
  AUTH_CONFIG_MISSING:
    "SeoTool.im auth is not configured. Follow the README setup steps for Cloudflare Access.",
  PAYMENT_REQUIRED:
    "An active hosted subscription is required before you can use SeoTool.im.",
  INSUFFICIENT_CREDITS:
    "You've run out of credits. Add more credits or upgrade your plan to continue.",
  QUOTA_EXCEEDED:
    "You've reached the usage limit for this feature. Upgrade your plan to continue.",
  PLAN_LIMIT_REACHED:
