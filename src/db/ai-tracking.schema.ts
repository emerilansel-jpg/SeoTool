...
export const aiTrackingConfigs = sqliteTable(
  "ai_tracking_configs",
  {
...
export const aiTrackingPrompts = sqliteTable(
  "ai_tracking_prompts",
  {
    id: text("id").primaryKey(),
...
export const aiTrackingRuns = sqliteTable(
  "ai_tracking_runs",
  {
    id: text("id").primaryKey(),
    configId: text("config_id")
...
export const aiTrackingObservations = sqliteTable(
...
export const aiTrackingMentions = sqliteTable(
  "ai_tracking_mentions",
  {
    ...
    brandName: text("brand_name").notNull(),
    domain: text("domain").notNull(),
    isTargetBrand: integer("is_target_brand", { mode: "boolean" })
      .notNull()
      .default(false),
...
export const aiTrackingCitations = sqliteTable(
