...
export interface CrawledPageResult {
  ...
  /**
   * Visible body text (script/style/noscript/svg stripped). Persisted to D1
   * for per-page entity/topic analysis; empty/missing pages store null.
   * NOT included in StepPageSummary — too large for durable step state.
   */
