...
import { getGa4ReportTool } from "@/server/mcp/tools/ga4-tools";
import {
  getAuditIssuesTool,
  getAuditPagesTool,
  getAuditStatusTool,
...
export function registerSeoToolMcpTools(server: McpServer) {
  server.registerTool(
    whoamiTool.name,
    whoamiTool.config,
  ...
  server.registerTool(
    getGa4ReportTool.name,
    getGa4ReportTool.config,
    instrumentMcpToolHandler(
      getGa4ReportTool.name,
      getGa4ReportTool.config.outputSchema,
      getGa4ReportTool.handler,
    ),
  );
  server.registerTool(
  ...
  server.registerTool(
    getContentScoresTool.name,
    getContentScoresTool.config,
    instrumentMcpToolHandler(
      getContentScoresTool.name,
      getContentScoresTool.config.outputSchema,
      getContentScoresTool.handler,
    ),
  );
  server.registerTool(
    getContentGapTool.name,
    getContentGapTool.config,
    instrumentMcpToolHandler(
      getContentGapTool.name,
      getContentGapTool.config.outputSchema,
      getContentGapTool.handler,
    ),
  );
  server.registerTool(
