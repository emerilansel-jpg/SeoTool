...
function navHtml(): string {
  ...
  <span class="nav-links"><a href="https://seotool.im">SeoTool.im</a><a href="https://github.com/every-app/open-seo">GitHub</a></span>
</nav>`;
}
...
function footerHtml(): string {
  ...
  <span class="foot-links">
    ...
    <a href="https://seotool.im">SeoTool.im</a>
