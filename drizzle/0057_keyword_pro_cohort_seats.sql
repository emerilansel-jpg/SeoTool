ALTER TABLE `plan_config` ADD `reserved_seats` integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE `keyword_pro_memberships` ADD `seat_reserved` integer DEFAULT false NOT NULL;--> statement-breakpoint
